package com.example.application.views.statusfeed;
...
@PageTitle("Status Feed")
@Route(value = "feeds", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@PermitAll
public class StatusFeedView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public StatusFeedView() {
        addClassName("status-feed-view");
        setSizeFull();
        grid.setHeight("100%");
