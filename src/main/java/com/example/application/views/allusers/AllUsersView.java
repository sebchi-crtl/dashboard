package com.example.application.views.allusers;
...
@PageTitle("AllUsers")
@Route(value = "all_users/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("admin")
@Uses(Icon.class)
public class AllUsersView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "all_users/%d/edit";
    ...
    public AllUsersView(@Autowired SamplePersonService samplePersonService) {
